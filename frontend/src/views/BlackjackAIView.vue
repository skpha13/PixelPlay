<template>
    ...
    <div class="blackjack-pvp">
      ...
      <div class="players">
        <div class="player" v-if="gameState">
          ...
          <p class="score">Score: {{ gameState.player1Score === 21 ? 'Blackjack!' : gameState.player1Score }}</p>
        ...
        <div class="player" v-if="gameState">
          ...
          <p class="score">Score: {{ gameState.player2Score === 21 ? 'Blackjack!' : gameState.player2Score }}</p>
  ...
  .blackjack-pvp {
    text-align: center;
    background-color: #0b3d91; /* Casino table green */
    padding: 20px;
    border-radius: 10px;
  }
